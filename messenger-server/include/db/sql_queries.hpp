...
// --- DDL: Creating tables and indexes ---
    ...
    constexpr const char* INSERT_USER =
        "INSERT INTO users (username, password, password_salt, email, phone, display_name, bio, avatar_url)"
        "VALUES (?, ?, ?, ?, ?, ?, '', '');";
    ...
    constexpr const char* GET_USER_PROFILE =
        "SELECT username, display_name, bio, avatar_url FROM users WHERE username = ?;";

    constexpr const char* UPDATE_USER_PROFILE =
